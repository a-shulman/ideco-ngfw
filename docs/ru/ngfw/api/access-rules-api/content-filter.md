...
{% cut "Включение/выключение Контент-фильтра" %}
...
{% cut "Получение настройки безопасного поиска" %}
...
{% cut "Изменение настройки безопасного поиска" %}
...
{% cut "Получение текущего состояние модуля морфологического анализа" %}
...
{% cut "Изменение состояния модуля морфологического анализа" %}
...
{% cut "Создание дополнительного словаря" %}
...
{% cut "Редактирование дополнительного словаря" %}
...
{% cut "Удаление дополнительного словаря" %}

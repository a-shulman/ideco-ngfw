...
{% cut "Получение настроек Ideco Center" %}
...
{% cut "Изменение настроек Ideco Center" %}
...
{% cut "Загрузка корневого сертификата Ideco Center на NGFW" %}
...
{% cut "Удаление корневого сертификата Ideco Center" %}
...
{% cut "Отключение NGFW от Ideco Center" %}
...
{% cut "Получение настройки включенности синхронизации правил" %}
...
{% cut "Включение/выключение синхронизации правил" %}
...
{% cut "Получение списка групп серверов в Ideco Center" %}
...
{% cut "Получение списка подключенных серверов" %}
...
{% cut "Перемещение подключенных серверов между группами/подтверждение подключения сервера к Ideco Center" %}
...
{% cut "Удаление сервера из Ideco Center" %}
...
{% cut "Получение списка категорий (предустановленных и пользовательских)" %}
...
{% cut "Получение списка пользовательских категорий" %}
...
API для управления морфологическим анализом представлен в [статье](../../ngfw/api/access-rules-api/content-filter.md#morfologicheskii-analiz).

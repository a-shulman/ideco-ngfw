...
{% cut "Примечания к релизу Ideco UTM 12.0 СБОРКА 588" %}
...
* Добавлена возможность создать правило авторизации только по [MAC-адресу](../../../ngfw/settings/users/authorization/IP-and-MAC-authorization/mac.md);
* Добавлена [фильтрация баннерной рекламы](../../../ngfw/settings/services/nextdns.md) на уровне DNS;
* Добавлена динамическая маршрутизация на базе [OSPF](../../../ngfw/settings/services/ospf.md);
* Добавлена возможность возврата на прошлую версию после обновления;
* Добавлено резервирование [IP к MAC](../../../ngfw/settings/services/dhcp.md#nastroika-dhcp-servera-s-privyazkoi-ip-k-mac) в разделе DHCP;
* Добавлена возможность запускать веб-интерфейс для [Антиспама](../../../ngfw/settings/access-rules/antivirus.md);
* Добавлена возможность отключать созданные правила в [Исключениях прокси](../../../ngfw/settings/services/proxy/exclusions.md).
  
**Исправления и изменения**

* Для клиентов, подключенных к Ideco UTM по IKEv2/IPsec, маршруты передаются автоматически;
* Правила [Предотвращения вторжений](../../../ngfw/settings/access-rules/ips.md), [Контроля приложений](../../../ngfw/settings/access-rules/application-control.md) и [Ограничение скорости](../../../ngfw/settings/access-rules/shaper.md) обрабатывают поступающий по VPN трафик из внешней сети;
...
* Правила [Предотвращения вторжений](../../../ngfw/settings/access-rules/ips.md), [Контроля приложений](../../../ngfw/settings/access-rules/application-control.md) и [Ограничение скорости](../../../ngfw/settings/access-rules/shaper.md) перестали обрабатывать трафик между локальными сетями и сетями филиалов;
* Переработан [раздел с сертификатами](../../../ngfw/settings/services/certificates/README.md);
* Переработан и улучшен раздел авторизации пользователей по [IP-адресу/MAC-адресу](../../../ngfw/settings/users/authorization/IP-and-MAC-authorization/README.md);
* Новая версия модуля [Контроль приложений](../../../ngfw/settings/access-rules/application-control.md).
...
* [Обнаружение устройств](../../../ngfw/settings/users/device-discovery.md) теперь создает авторизацию по MAC для локальных адресов в одном ethernet-сегменте (ранее создавалась авторизация по IP);

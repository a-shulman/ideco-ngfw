...
1\. Сохраните скрипты запуска обновления баз модулей безопасности в папку с файлами, скачанными на шаге 4 [Офлайн-регистрации](../../ngfw/installation/server-registration.md):

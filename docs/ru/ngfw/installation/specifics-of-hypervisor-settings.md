...
{% cut "Ideco NGFW совместим с указанными гипервизорами" %}
...
![](../../_images/specifics-of-hypervisor-settings4.png)

2\. Укажите **Имя** виртуальной машине и установите остальные настройки как на скриншоте:

 ![](../../_images/specifics-of-hypervisor-settings5.png)

3\. Выберите хранилище для виртуальной машины:

![](../../_images/specifics-of-hypervisor-settings6.png)
...
![](../../_images/specifics-of-hypervisor-settings7.png)

5\. Включите **UEFI** на вкладке **VM Options**, выбрав в поле **Firmware** EFI:

![](../../_images/specifics-of-hypervisor-settings8.png)

6\. Нажмите **Finish**:

![](../../_images/specifics-of-hypervisor-settings9.png)
...
![](../../_images/specifics-of-hypervisor-settings24.png)

2\. Установите размер оперативной памяти ВМ (**16 ГБ**) и нажмите **Включить EFI**:
    
![](../../_images/specifics-of-hypervisor-settings25.png)

3\. Создайте виртуальный жесткий диск под ВМ (Объем не меньше **150ГБ**):

![](../../_images/specifics-of-hypervisor-settings26.png)
...
![](../../_images/specifics-of-hypervisor-settings27.png)
...
![](../../_images/specifics-of-hypervisor-settings28.png)

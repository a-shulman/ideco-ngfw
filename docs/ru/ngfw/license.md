...
{% cut "Подробнее о лицензирование Кластеризации" %}
...
1\. На вкладке **Лицензирование** нажмите ![../_images/icon-lk1.png). Далее в выберите нужную лицензию и сохраните изменения нажав **Привязать лицензию**.

2\. На вкладке **Лицензирование** выберите **Свободные лицензии** и нажмите ![../_images/icon-lk.png). Далее укажите нужный сервер и сохраните изменения нажав **Привязать**.
...
* В личном кабинете MY.IDECO в разделе **NGFW -> Лицензирование**, нажав на иконку ![../_images/eye-icon.png) напротив нужного сервера;

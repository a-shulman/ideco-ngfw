...
Процесс настройки подробно описан в статье [Настройка автоматической аутентификации на NGFW на Linux](../../../ngfw/recipes/popular-recipes/auto-authorization-linux.md). Данный скрипт подходит для всех Linux-систем c Python 3.5 и выше.

...
Правила разделов [Предотвращения вторжений](../../../ngfw/settings/access-rules/ips/README.md), [Контроля приложений](../../../ngfw/settings/access-rules/application-control.md) и [Ограничение скорости](../../../ngfw/settings/access-rules/shaper.md) не обрабатывают трафик между локальными сетями и сетями филиалов.
...
![](../../../_images/application-control.png)
...
{% cut "Описание протоколов, распознаваемых модулем" %}
...
{% cut "Описание сервисов, распознаваемых модулем" %}

...
![](../../../_images/application-control.gif)
...
О блокировке программ удаленного доступа, анонимайзеров, торрентов и других популярных ресурсов смотрите в статье [Блокировка популярных ресурсов](../../../ngfw/recipes/popular-recipes/blocking-popular-resources.md).

...
<img src="../../../_images/suricata-logi.png" alt="" data-size="original">
...
При наведении на колонку **ID** в строке с правилом, появится кнопка **Добавить в исключения** (![](../../../_images/icon-lock.png)), при нажатии на которую сигнатура будет добавлена в  исключения: 

![](../../../_images/suricata.gif)

Скачайте CSV-файл с логами системы предотвращения вторжений за определенный период по соответствующей кнопке. 

{#top}

{% cut "Действия для корректного отображения информации из CSV-файла в MS Excel" %}
...
<img src="../../../_images/suricata-except.png" alt="" data-size="original">
...
<img src="../../../_images/ex2suricata.png" alt="" data-size="original">
...
{% cut "Как исключить узел из обработки системой IDS/IPS" %}

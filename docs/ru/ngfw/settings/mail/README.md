...
При настройке [кластера ](../../../ngfw/settings/server-management/cluster/cluster.md)почта будет доступна для работы только в режиме почтового релея. Хранение почтовых ящиков отключено.

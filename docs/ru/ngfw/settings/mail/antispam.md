...
Для работы антиспама и антивируса Касперского необходимо включить [почтовый сервер](../../../ngfw/settings/mail/mail-server-settings/mail-server-settings.md). Перед загрузкой ключа обязательно включите модуль антиспама и антивируса.

{% endnote %}

![](../../../_images/antispam1.png)

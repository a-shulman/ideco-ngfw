...
<img src="../../../_images/dnat-ssh.jpg" alt="" data-size="original">

После сохранения созданное правило будет выглядеть следующим образом:

![](../../../_images/dnat-ssh-table.png)
...
<img src="../../../_images/ports-destination.png" alt="" data-size="original">
...
* Если в одной локальной сети находятся пользователи и сервер с опубликованным при помощи DNAT-правила ресурсом, вероятна асимметричная маршрутизация. Информация о способах устранения асимметричной машрутизации трафика представлена в [статье](../../../ngfw/recipes/popular-recipes/access-to-remote-networks.md).

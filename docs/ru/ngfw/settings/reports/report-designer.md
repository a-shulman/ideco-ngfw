...
* [Системный журнал](../../../ngfw/settings/reports/logs.md) (кроме логов служб `strongswan`, `squid`, `ideco-app-control`, `fail2ban`) - 90 дней;
* Логи [служб](../../../ngfw/settings/server-management/terminal/README.md) `strongswan`, `squid`, `ideco-app-control`, `fail2ban` (Системный журнал) - 14 дней;
...
{% cut "Пример настройки ежемесячного отчета в формате CSV" %}

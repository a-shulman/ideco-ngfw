...
![](../../../../_images/ips-security-profiles.png)

3\. Нажмите на ![](../../../../_images/icon-edit.png) напротив только что созданного профиля и выберите **Сигнатуры**.
...
* Выберите **Фильтры**:
    ...
    * Цель (доступные варианты: *Клиент*, *Сервер*):
    ...
    ![](../../../../_images/ips-security-profiles5.png)
...
* Переопределите действие для выбранных сигнатур, выбрав необходимое в соответствующем поле, или оставьте действие *По умолчанию*:
    ...
    ![](../../../../_images/ips-security-profiles2.png)

* Нажмите **Добавить**. Правило выбора сигнатур появится в таблице профиля:

![](../../../../_images/ips-security-profiles4.png)
...
* В таблице отметьте сигнатуры, которые хотите добавить в профиль (при необходимости воспользуйтесь **Фильтром** отображения):
    ...
    ![](../../../../_images/ips-security-profiles1.png)
...
![](../../../../_images/ips-security-profiles3.png)

{% note info %}

В один профиль **Предотвращения вторжений** можно добавить несколько правил выбора сигнатур. Их приоритет можно менять в таблице профиля кнопками ![](../../../../_images/icon-up.png) и ![](../../../../_images/icon-down.png).
...
{% cut "Пример отображения профиля при выборе нескольких действий сигнатур" %}

Настройки профиля Test:

![](../../../../_images/ips-security-profiles11.png)
...
![](../../../../_images/ips-security-profiles12.png)

{% endcut %}

Чтобы просмотреть созданный профиль (описание и правила выбора сигнатур), нажмите на ![](../../../../_images/icon-eye.png). На вкладке **Выбранные сигнатуры** представлены все сигнатуры, для которых настроено одно или несколько действий. 

![](../../../../_images/ips-security-profiles13.png)

...
* **Роль** - выберите роль:
  ...
  * **Просмотр отчетов** - доступ к части раздела [Отчеты и журналы](../../../ngfw/settings/reports/README.md), а именно: **Трафик**, **Системный журнал**, **Журнал веб-доступа**, **Журнал антивируса**, **События безопасности** и **Журнал авторизации**;
  * **Создание отчетов** - доступ к части раздела [Отчеты и журналы](../../../ngfw/settings/reports/README.md), а именно: **Трафик**, **Системный журнал**, **Журнал веб-доступа**, **Журнал антивируса**, **События безопасности**, **Журнал авторизации** и **Конструктор отчетов**.

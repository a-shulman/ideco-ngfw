...
![](../../../_images/local_add_menu_backup.png)
...
Чтобы перенести установленный Ideco UTM с одного сервера на другой с сохранением всех настроек, воспользуйтесь статьей [Перенос данных и настроек на другой сервер](../../../ngfw/recipes/popular-recipes/transferring-data-to-another-server.md).

...
{% cut "Если только установили сервер Ideco UTM" %}
...
{% cut "Если создаете резервную ноду из уже установленного сервера Ideco UTM с лицензией и доступом в интернет:" %}

1\. Перейдите в локальное меню.

2\. Выберите пункт **Создание кластера**:

<img src="/../_images/cluster4.png" alt="" data-size="original">
...
<img src="/../_images/cluster-warning-local.png" alt="" data-size="original">

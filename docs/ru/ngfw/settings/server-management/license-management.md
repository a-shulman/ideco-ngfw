...
* [регистрация сервера](../../../ngfw/installation/server-registration.md);
...
* На вкладке **Лицензирование** нажмите ![](../../../_images/icon-lk-licens.png). Далее в открывшемся окне выберите нужную лицензию и сохраните изменения, нажав **Привязать лицензию**.
...
3\. Сформируйте ссылку на скачивание баз и лицензии, перейдите по ней на устройстве с доступом в интернет (подробнее - в [статье](../../../ngfw/installation/server-registration.md#офлайн-регистрация)).

...
* В [MY.IDECO](https://my.ideco.ru/) на вкладке **Лицензирование** нажмите ![](../../../_images/icon-lk1.png). Далее в открывшемся окне выберите нужную лицензию и сохраните изменения, нажав **Привязать лицензию**;
* В [MY.IDECO](https://my.ideco.ru/) на вкладке **Лицензирование** выберите **Свободные лицензии** и нажмите ![](../../../_images/icon-lk.png). Далее укажите нужный сервер и сохраните изменения, нажав **Привязать**.
...
* В личном кабинете [MY.IDECO](../../../settings-my/README.md) в разделе **NGFW -> Лицензирование**, нажав на иконку ![](../../../_images/icon-eye.png) напротив нужного сервера;

...
В режиме редактирования доступно изменение названия, сетевой карты (по кнопке ![](../../../../_images/icon-edit.png)), зоны, индекса интерфейса для Netflow и настроек конфигурации (вручную или автоматически): 

![](../../../../_images/interfaces.gif)
...
![](../../../../_images/interfaces19.png)

{% note info %}

При миграции NGFW с одной физической машины на другую (перенос диска или восстановление бэкапа на новом оборудовании), будут восстановлены настройки всех сетевых интерфейсов, указанные до миграции. Для удаления ненужных интерфейсов воспользуйтесь кнопкой ![](../../../../_images/delete-icon.png).
...
На этой вкладке пробрасываются сетевые карты и VLAN-интерфейсы Ideco NGFW в виртуальные серверы, созданные в разделе **Управление сервером -> [VCE](../../../../ngfw/settings/server-management/vce.md)**.  

Чтобы назначить сетевую карту или VLAN-интерфейс VCE, нажмите **Добавить** и выполните действия:

1\. Выберите сетевую карту:

![](../../../../_images/interfaces22.png)

2\. Заполните следующие поля:

![](../../../../_images/interfaces23.png)

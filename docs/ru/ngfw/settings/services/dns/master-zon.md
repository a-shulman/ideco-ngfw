...
Не используйте Master-зоны для блокировки доступа к сайтам, для этого есть другие [средства](../../../../ngfw/settings/access-rules/content-filter/). \
...
{% cut "Описание параметров записи" %}
...
<img src="../../../../_images/dns5.png" alt="" data-size="original">

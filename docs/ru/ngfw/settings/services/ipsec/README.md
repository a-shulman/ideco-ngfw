...
* **Phase 1 (IKE):**
  ...
  * prf (функция генерации случайных значений):
    * как правило, настраивается автоматически в зависимости от выбора алгоритмов integrity (поэтому в примере [ниже](../../../../ngfw/settings/services/ipsec/site-to-site/ipsec-connection-pfsense-to-utm.md) значение prf: PRF-HMAC-SHA512);

...
{% cut "Первоначальная настройка Ideco NGFW и Cisco IOS" %}

### Настройка Ideco NGFW

Настройте на Ideco NGFW локальный и внешний интерфейсы. Подробная информация находится в статье [Первоначальная настройка](../../../../../ngfw/installation/initial-setup.md).
...
{% cut "Настройка исходящего подключения Ideco NGFW к Cisco IOS" %}
...
{% cut "Настройка входящего подключения Ideco NGFW к Cisco IOS" %}

...
![](../../../../../_images/ipsec-utm-to-utm-tunnel.png)
...
{% cut "Действия для доступа к удаленным локальным сетям NGFW" %}
...
Если соединение по IPsec не устанавливается, воспользуйтесь [статьей](../../../../../ngfw/recipes/problem-diagnosis/ipsec.md).

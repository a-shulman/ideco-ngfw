...
Если вы используете Windows 7, необходимо создать подключение вручную (cм. статью [Инструкция по созданию подключения в Windows 7](../../../../../ngfw/recipes/popular-recipes/vpn/connection-for-windows7.md)).
...
Воспользуйтесь инструкцией для создания подключения в Windows 8-ой и 10-ой версии в статье [IPSec IKEv2](../../../../../ngfw/recipes/popular-recipes/vpn/connection-for-windows10.md).

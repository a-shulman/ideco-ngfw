...
1\. В Ideco UTM откройте вкладку **Сервисы -> IPSec -> Устройства**, нажмите на значок ![](../../../../../../_images/icon-ok-with.png) и заполните следующие поля:

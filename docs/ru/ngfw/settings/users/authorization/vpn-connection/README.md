...
* [IKEv2](../../../../../ngfw/settings/users/authorization/vpn-connection/ipsec-ikev2.md) - рекомендуемый протокол с точки зрения скорости и безопасности;
* [SSTP](../../../../../ngfw/settings/users/authorization/vpn-connection/sstp.md) - подходит для использования в средах с ограничениями на порты; 
* [L2TP/IPsec](../../../../../ngfw/settings/users/authorization/vpn-connection/l2tp-ipsec.md) - обеспечивает баланс между безопасностью и совместимостью;
* [PPTP](../../../../../ngfw/settings/users/authorization/vpn-connection/pptp.md) - не рекомендуется. Этот способ подключения **крайне небезопасен** и оставлен исключительно для совместимости со старыми решениями.

## Предварительные требования

Чтобы VPN-подключение работало на устройствах пользователей, необходимо загрузить [корневой сертификат](../../../../../ngfw/settings/services/certificates/README.md):
...
![](../../../../../_images/vpn-authorization20.png)
...
Если требуется настроить VPN-подключение к [Loopback-интерфейсу](../../../../../ngfw/settings/services/connection-to-provider/loopback.md), оставьте поле **Зона** пустым.

* **DNS-суффикс** - укажите DNS-суффикс, если для подключения по VPN используется [Ideco Client](../../../../../ngfw/settings/users/ideco-client/README.md) (опционально).
...
![](../../../../../_images/vpn-authorization12.png)
...
![](../../../../../_images/vpn-authorization13.png)
...
* **Способ 2FA** - выберите способ [двухфакторной аутентификации](../../../../../ngfw/settings/users/two-factor-authentication.md). Для разных групп пользователей возможно указать разные типы двухфакторной аутентификации (опционально).
...
Чтобы отключить правило, нажмите на ![](../../../../../_images/icon-on.png) в столбце управления. Чтобы удалить правило, нажмите ![](../../../../../_images/icon-delete1.png).

...
* Режим работы [Device VPN](device-vpn.md);
* Сбор данных о подключающихся устройствах.

{% note info %}

Сбор данных о подключающихся устройствах позволяет задавать критерии проверки - [HIP-профили](../../../../ngfw/settings/users/hip-profiles.md) - и использовать их в правилах **Файрвола**.
...
* Использовать альтернативный способ [VPN-подключения](../../../../ngfw/settings/users/authorization/vpn-connection/README.md).
...
* Информация о сессиях пользователей отображается в разделе [Авторизованные пользователи](../../../../ngfw/settings/monitor/authorized-users.md):

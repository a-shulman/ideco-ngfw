...
![](../_images/security-profiles1.png)

* Таблица профилей **Предотвращения вторжений**:

![](../_images/security-profiles2.png)

* Таблица профилей **Web Application Firewall**:

![](../_images/security-profiles3.png)
...
<img src="../_images/security-profiles5.png" alt="" data-size="original">
...
![](../_images/security-profiles6.png)

{% note tip %}

Принцип создания и настройки профилей в Ideco Center соответствуют принципам Ideco NGFW. Подробное описание в статье [Контроль приложений](../ngfw/settings/security-profiles/application-control/README.md).
...
![](../_images/application-control5.png)
...
Принцип создания и использования профилей **Предотвращения вторжений** в Ideco Center аналогичен Ideco NGFW. Подробнее можно узнать в статье [Предотвращение вторжений](../ngfw/settings/security-profiles/ips-profiles/README.md)
...
![](../_images/cc-waf-profiles1.png)

{% note tip %}

Для удобной настройки **Web Application Firewall** на Ideco NGFW, соединенных с Ideco Center, создайте профиль WAF на Ideco Center и используйте его в Ideco NGFW. Подробное описание в статье [Web Application Firewall](../ngfw/settings/security-profiles/waf-profiles.md).
